...
###
module.exports.Harvester = class extends stream.Duplex
	constructor: (options = {}) ->
	...
	# module.exports.Harvester.prototype.onend = function () {
	# 	console.log('onend');
	# };
	# module.exports.Harvester.prototype.unpipe = function () {
	# 	console.log('unpipe');
	# };
	# module.exports.Harvester.prototype.end = function () {
	# 	this.push(null);
	# };
	processLine: (line) ->
